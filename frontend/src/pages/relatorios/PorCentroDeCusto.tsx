...
export function PorCentroDeCusto() {
  ...
  const gerar = async (e: React.FormEvent) => {
    ...
    setErro(null)
    try {
      const resultado = await relatoriosApi.porCentroDeCusto({
  ...
  return (
    <div className="page max-w-4xl">
      <h1 className="page-title mb-4">Relatório por Centro de Custo</h1>
      ...
      {linhas && <ResultTable headers={['Centro de Custo', 'Qtde', 'Valor total']} rows={linhas} />}
    </div>
  )
}
